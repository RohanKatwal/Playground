...
// Q . You are given an array(list) strarr of strings and an integer k. Your task is to return the first longest string consisting of k consecutive strings taken in the array.
...
//   }
//   let longest="";
//   for(let i=0; i<=strarr.length-k;i++){//-k ensures we don’t go out of bounds.
...
// Q. There is a bus moving in the city which takes and drops some people at each bus stop.
